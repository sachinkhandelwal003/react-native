...
(function ($) {
  ...
  -------------------------------------------------------------------------------------*/
    var deleteFile = function (e) {
        // Disabled for cart items - using AJAX handler in ajax.js instead
        ...
        // Keep only the clear-file-delete functionality for other uses
  ...
  ------------------------------------------------------------------------------------- */
    ...
    /* Handle Progress
  ------------------------------------------------------------------------------------- */
   // Shopping Cart Data Structure - DISABLED (using AJAX cart instead)
/*
let shoppingCart = {
    items: [],
    subtotal: 0,
...
// Initialize the cart when page loads - DISABLED
$(document).ready(function() {
    // Using AJAX cart functionality in ajax.js instead
    handleProgress();
});
*/

// Add to Cart Function - DISABLED (using AJAX version)
/*
function addToCart(product) {
    // Using AJAX cart functionality in ajax.js instead
}

// Update Cart UI - DISABLED
function updateCartUI() {
    // Using AJAX cart functionality in ajax.js instead
}

// Handle Remove Item - DISABLED
$(document).on('click', '.tf-btn-remove', function() {
    // Using AJAX cart functionality in ajax.js instead
});
*/

// Your existing progress bar function
